...
INSERT INTO `tablecolumns` (`tabledefid`, `name`, `column`, `align`, `footerquery`, `displayorder`, `sortorder`, `wrap`, `size`, `format`, `roleid`) VALUES('tbld:26b04a81-35b5-5c64-8500-c25cb80653a6', 'notes', 'if(length(notes)>100,concat(left(notes,100),''...''),notes)', 'left', '', 2, '', 0, '99%', NULL, '');
INSERT INTO `tablecolumns` (`tabledefid`, `name`, `column`, `align`, `footerquery`, `displayorder`, `sortorder`, `wrap`, `size`, `format`, `roleid`) VALUES('tbld:26b04a81-35b5-5c64-8500-c25cb80653a6', 'hours', 'TIME_FORMAT(TIMEDIFF(concat(timeentries.enddate, '' '', timeentries.endtime),\r\nconcat(timeentries.startdate, '' '',timeentries.starttime)),''%k:%i'')', 'right', '', 5, '', 0, '', NULL, '');
INSERT INTO `tablecolumns` (`tabledefid`, `name`, `column`, `align`, `footerquery`, `displayorder`, `sortorder`, `wrap`, `size`, `format`, `roleid`) VALUES('tbld:26b04a81-35b5-5c64-8500-c25cb80653a6', 'iid', 'timeentries.invoiceid', 'left', '', 4, '', 0, '', 'invoice', '');
INSERT INTO `tablecolumns` (`tabledefid`, `name`, `column`, `align`, `footerquery`, `displayorder`, `sortorder`, `wrap`, `size`, `format`, `roleid`) VALUES('tbld:26b04a81-35b5-5c64-8500-c25cb80653a6', 'location', 'timeentries.location', 'left', '', 3, '', 0, '', NULL, '');
INSERT INTO `tablecolumns` (`tabledefid`, `name`, `column`, `align`, `footerquery`, `displayorder`, `sortorder`, `wrap`, `size`, `format`, `roleid`) VALUES('tbld:6d290174-8b73-e199-fe6c-bcf3d4b61083', 'id', 'clients.id', 'left', '', 0, '', 0, '', 'client', '');
