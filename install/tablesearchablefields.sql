...
#
INSERT INTO `tablesearchablefields` (`tabledefid`, `field`, `name`, `displayorder`, `type`) VALUES('tbld:26b04a81-35b5-5c64-8500-c25cb80653a6', 'clients.firstname like "{{value}}%" or clients.lastname like "{{value}}%"', 'client', 1, 'whereclause');
