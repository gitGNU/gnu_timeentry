...
*/
INSERT INTO `tablegroupings` (`tabledefid`, `field`, `displayorder`, `ascending`, `name`, `roleid`) VALUES('tbld:26b04a81-35b5-5c64-8500-c25cb80653a6', 'concat(clients.firstname," ",clients.lastname," - ",clients.company)', 1, 1, 'Client', '');
