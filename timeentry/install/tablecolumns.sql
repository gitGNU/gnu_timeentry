...
INSERT INTO `tablecolumns` (`tabledefid`, `name`, `column`, `align`, `footerquery`, `displayorder`, `sortorder`, `wrap`, `size`, `format`, `roleid`) VALUES('tbld:26b04a81-35b5-5c64-8500-c25cb80653a6', 'notes', 'if(length(notes)>100,concat(left(notes,100),''...''),notes)', 'left', '', 3, '', 0, '99%', NULL, '');
